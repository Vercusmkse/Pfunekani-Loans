    ...
    <div className="space-y-16 py-8 animate-fadeIn">
      <div className="text-center max-w-3xl mx-auto space-y-6 px-4">
        <div className="inline-flex items-center gap-1.5 bg-emerald-500/10 border border-emerald-500/20 rounded-full px-3 py-1 text-xs text-emerald-400 font-semibold uppercase tracking-wider">
          <Sparkles className="w-3.5 h-3.5 animate-pulse" /> Community Deployed
          Liquidity Engine
        </div>
        <h1 className="text-4xl sm:text-6xl font-black text-white tracking-tight leading-none">
          Transparent Lending for Local{" "}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-teal-400 to-amber-400">
            Micro Enterprises
          </span>
        </h1>
        <p className="text-slate-400 text-sm sm:text-base max-w-xl mx-auto leading-relaxed">
          Access immediate liquidity for agricultural supplies, spaza shop
          stock, or delivery logistics. No hidden costs. Fixed 30-day cycles.
        </p>
        ...
        <div className="space-y-5">
          <div>
            <h3 className="text-lg font-black text-white uppercase tracking-wider">
              Maturity Cost Calculator
            </h3>
            <p className="text-xs text-slate-400 mt-1">
              Drag the parameter controller to evaluate the strict 30-day
              repayment schedules.
            </p>
          </div>
          ...
          <div className="bg-slate-950/60 p-3.5 rounded-xl border border-slate-850 flex gap-2 items-start">
            ...
            <p className="text-[11px] text-slate-400 leading-normal">
              First-time registration limits capping is automatically enforced
              at <strong className="text-white">R500</strong>. Complete
              successful payment profiles to scale up your index limit to{" "}
              <strong className="text-emerald-400">R10,000</strong>.
            </p>
          </div>
        </div>
