        ...
        >
          ...
          <div>
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[9px] bg-emerald-500/10 text-emerald-400 font-bold border border-emerald-500/20 px-1.5 py-0.5 rounded-full uppercase">
                30-Day Fixed
              </span>
            </div>
            <p className="text-[10px] text-slate-400 font-medium">
              Microfinance Management Tower
            </p>
          </div>
        </div>
